...
<head>
    ...
    <script type="text/javascript">var baseurl = "{{ url('/') }}";var referer='{{Input::get('referer')}}'</script>
    <!--[if lt IE 9]>
...
<body class="page-body login-page login-form-fall">
    ...
    <script src="{{asset('backend/js/gsap/main-gsap.js')}}" ></script>
    ...
    <script src="{{asset('backend/js/api.js')}}" ></script>
    <script src="{{asset('backend/js/cookies.min.js')}}" ></script>
