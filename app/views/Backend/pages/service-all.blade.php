...
@section('page_title')
<h1>一级分类服务 <span class="middle-sep mg-x-10"></span><a href="{{url('/admin/service/new')}}" class="btn btn-info">新建</a></h1>
@stop
@section('content')
<div class="row">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$service->usort}}</td>
                    <td>{{isset($service->created_at) ? $service->created_at->format('Y-m-d H:i') : '无'}}</td>
                    <td class="do">
                        ...
                        <a href="{{url('/admin/service/edit',['id'=>$service->id]) }}" ><span class="entypo-pencil"></span>修改</a>
